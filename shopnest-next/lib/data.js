...
export const initialProducts = [
  {
    id:1, name:'Apple iPhone 15 Pro Max 256GB', brand:'Apple', category:'Mobiles',
  ...
  {
    id:2, name:'Samsung 65" 4K QLED Smart TV', brand:'Samsung', category:'Electronics',
  ...
  {
    id:4, name:'Nike Air Max 270 Running Shoes', brand:'Nike', category:'Fashion',
  ...
  {
    id:5, name:'MacBook Air M3 13-inch 8GB 256GB', brand:'Apple', category:'Electronics',
  ...
  {
    id:6, name:'LG 1.5 Ton 5-Star Inverter AC', brand:'LG', category:'Appliances',
  ...
  {
    id:7, name:'Fossil Gen 6 Smartwatch', brand:'Fossil', category:'Fashion',
  ...
  {
    id:8, name:'Nescafé Gold Blend 200g', brand:'Nestlé', category:'Grocery',
  ...
  {
    id:9, name:'Ergonomic Office Chair', brand:'Herman Miller', category:'Furniture',
  ...
  {
    id:10, name:'OnePlus 12R 5G 256GB', brand:'OnePlus', category:'Mobiles',
  ...
  {
    id:11, name:'Maybelline Fit Me Foundation', brand:'Maybelline', category:'Beauty',
    price:399, mrp:549, rating:4.3, reviews:4521, stock:300, discount:27,
    desc:'Natural finish, 40 shades, oil control',
    image:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80',
  },
  {
    id:12, name:'LEGO Technic McLaren Formula 1', brand:'LEGO', category:'Toys',
  ...
  {
    id:13, name:'Adidas Ultraboost 23 Shoes', brand:'Adidas', category:'Sports',
  ...
  {
    id:14, name:'Instant Pot Duo 7-in-1 5.7L', brand:'Instant Pot', category:'Appliances',
  ...
  {
    id:15, name:'Canon EOS R50 Mirrorless Camera', brand:'Canon', category:'Electronics',
  ...
  {
    id:16, name:'boAt Airdopes 141 TWS Earbuds', brand:'boAt', category:'Electronics',
